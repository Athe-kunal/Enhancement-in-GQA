...
def main(rank, world_size,run):
    ...
    val_rouge_dict, test_rouge_dict = train(rank,world_size,kv_heads=4,logging_name="randwgqa",run=run,model_name=config.MODEL_NAME,similarity_flag=False,weight_flag=True,if_random=True)
