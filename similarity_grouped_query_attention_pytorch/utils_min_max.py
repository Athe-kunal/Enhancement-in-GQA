...
def train(rank,world_size,kv_heads:int,logging_name:str,run,model_name:str=config.MODEL_NAME,similarity_flag:bool=False,weight_flag:bool=False,if_random:bool=False,min_flag=False):
